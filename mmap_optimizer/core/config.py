...
class RefactoredConfig:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {
            ...
            "fewshot_optimization": {
                ...
                "selection_batch_size": self.fewshot_optimization.selection_batch_size,
                "validation_batch_size": self.fewshot_optimization.validation_batch_size,
                "candidate_pool_size": self.fewshot_optimization.candidate_pool_size,
                "selection_strategy": self.fewshot_optimization.selection_strategy,
                "fallback_strategy": self.fewshot_optimization.fallback_strategy,
                ...
                "max_context_examples": self.fewshot_optimization.max_context_examples,
    ...
    def from_dict(cls, data: dict[str, Any]) -> "RefactoredConfig":
        ...
        fewshot_config = FewshotConfig(
            ...
            selection_batch_size=fewshot_optimization_data.get("selection_batch_size"),
            validation_batch_size=fewshot_optimization_data.get("validation_batch_size"),
            candidate_pool_size=fewshot_optimization_data.get("candidate_pool_size", 20),
            selection_strategy=fewshot_optimization_data.get("selection_strategy", "quota_diverse"),
            fallback_strategy=fewshot_optimization_data.get("fallback_strategy", "difficulty_topk"),
            ...
            max_context_examples=fewshot_optimization_data.get("max_context_examples"),
            sampler=_sampler_config_from_dict(
