...
from ..patch import AnalysisPatch, ExtractionPatch, PatchMergeReport
...
try:
    from mmap_optimizer.patch.schema import Patch as _OldPatch
    from mmap_optimizer.patch.tree_reduce import TreeReducePatchMerger as _TreeReducePatchMerger
