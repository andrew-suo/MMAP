...
DEFAULT_OPTIMIZER_TEMPLATES = [
    ...
    PromptTemplateSpec("prompt_standardization", "1.1", "Map raw prompt content into a standard section structure losslessly.", ["original_prompt"], _contract("text", fallback="original prompt"), PROMPT_STANDARDIZATION_TEMPLATE, "high", ["prompt", "format"]),
