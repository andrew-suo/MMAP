...
def summarize_patch_test(round_id: str, patch_id: str | None, suite_id: str, base_evals: list[EvaluationRecord], patched_evals: list[EvaluationRecord]) -> PatchTestResult:
